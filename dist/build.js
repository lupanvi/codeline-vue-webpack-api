...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SearchForm = __webpack_require__(41);
	...
	var _WeatherDetail = __webpack_require__(44);
	...
	var routes = [{ path: '/', component: _Home2.default }, { path: '/weather/:woeid', component: _WeatherDetail2.default, props: true }, { path: '/search/:keyword', component: _Search2.default, props: true, name: 'search' }];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "D:\\codeline\\vue-final-webpack\\src\\Home.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    goToDetails: function goToDetails(woeid) {
	...
	//     <section id="home">
	//
	//         <weather woeid="2344116" v-on:click.native="goToDetails(2344116)"></weather>        
	//
	//         <hr />
	//
	//
	//         <weather woeid="638242" v-on:click.native="goToDetails(638242)"></weather> 
	//
	//
	//         <hr />
	//
	//
	//         <weather woeid="44418" v-on:click.native="goToDetails(44418)"></weather>
	//
	//
	//         <hr />
	//
	//
	//         <weather woeid="565346" v-on:click.native="goToDetails(565346)"></weather>                                
	//
	//
	//         <hr />
	//
	//
	//         <weather woeid="560743" v-on:click.native="goToDetails(560743)"></weather> 
	//
	//
	//         <hr />
	//
	//
	//         <weather woeid="9807" v-on:click.native="goToDetails(9807)"></weather>
	//
	//
	//     </section>
	//
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\codeline\\vue-final-webpack\\src\\Weather.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    getPostsByWoeid: function getPostsByWoeid(woeid) {
	      var _this = this;

	      var $this = this;

	      var url = '/weather.php?command=location&woeid=' + woeid;
	      axios.get(url).then(function (response) {

	        _this.result.city_name = response.data.title;
	        _this.result.today = response.data.consolidated_weather[0];
	        _this.result.consolidated_weather = response.data.consolidated_weather.map(function (cw) {
	    ...
	    getPostsByKeyword: function getPostsByKeyword(keyword) {
	      ...
	      var url = '/weather.php?command=search&keyword=' + keyword;
	      axios.get(url).then(function (response) {

	        if (response.data.length == 0) {
	          _this2.result.no_data = 'No results were found. Try changing the keyword!';
	        } else {
	          console.log(response.data[0].woeid);
	          _this2.getPostsByWoeid(response.data[0].woeid);
	        }
	      }).catch(function (error) {
	        console.log(error);
	      });
	    },
	    getDayName: function getDayName(dateString) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\codeline\\vue-final-webpack\\src\\Search.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\codeline\\vue-final-webpack\\src\\SearchForm.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports) {
	...
	// <template>
	//     <form class="form-inline" method="POST" v-on:submit.prevent="onSubmitForm">
	//       <div class="form-group">        
	//         <input type="text" v-model="search_input" class="form-control" id="search" name="search" placeholder="Search...">
	//       </div>
	//
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\codeline\\vue-final-webpack\\src\\WeatherDetail.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//     <section>  
	//
	//        <weather :woeid="woeid" consolidated="yes"></weather> 
	//
	//     </section>
	// </template>
	//
